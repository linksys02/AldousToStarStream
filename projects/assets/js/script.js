...
function linkForLikeShareWatch(){
  if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
      window.open("https://youtu.be/Xq1fjNPaPIE?si=iRQHxUxXDQmdncsa");//Paquito To KOF
} else {
    window.open("https://youtu.be/Xq1fjNPaPIE?si=iRQHxUxXDQmdncsa", "_blank");//Paquito To KOF   
}
}
